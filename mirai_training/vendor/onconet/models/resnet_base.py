...
import pdb
import numpy as np
from mirai_training.vendor.onconet.models.pools.factory import get_pool
from mirai_training.vendor.onconet.models.spatial_transformers.factory import get_spatial_transformer
from mirai_training.vendor.onconet.models.cumulative_probability_layer import Cumulative_Probability_Layer


class ResNet(nn.Module):
    """
        A ResNet model. Blocks can be Basic, Non-local, bottleneck or
        anything in mirai_training.vendor.onconet.models.blocks and intermixed in any order.
